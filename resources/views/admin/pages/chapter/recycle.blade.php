                                ...
                                <tbody>
                                    @foreach ($chapters as $chapter)
                                        <tr>
                                            ...
                                            <td><span class="text-ellipsis">{{ $chapter->deleted_at }}</span></td>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('admin.manga.chapter.restore',['id'=>$manga->id,'chapter_id'=>$chapter->id]) }}"
                                                    class="btn btn-success"><span class="glyphicon glyphicon-check"></span>
                                                </a>
                                            </td>
                                            <td>
                                                <a
                                                    href="{{ route('admin.manga.chapter.destroy',['id'=>$manga->id,'chapter_id'=>$chapter->id]) }}"
