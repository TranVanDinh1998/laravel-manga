                    ...
                    <div class="col-lg-4">
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="#!">{{ $manga->name }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="home7" role="tabpanel">
                                                    <form class="md-float-material card-block" method="POST"
                                                        ...
                                                        action="{{ route('manager.manga.update', ['id' => $manga->id]) }}">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name">Lượt like</label>
                                                                    <input type="text" class="form-control"
                                                                        name="updated_at"
                                                                        value="{{ $manga->like }}"
                                                                        placeholder="updated at" disabled>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name">Lượt dislike</label>
                                                                    <input type="text" class="form-control"
                                                                        name="updated_at"
                                                                        value="{{ $manga->dislike }}"
                                                                        placeholder="updated at" disabled>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="status"
                                                                        ...
                                                                        <option value="1" @if ($manga->status == 1) selected @endif>Hoàn thành</option>
                                                                        <option value="0" @if ($manga->status == 0) selected @endif>Đang tiến hành</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="verified"
                                                                        class="form-control form-control-primary">
                                                                        <option value="1" @if ($manga->verified == 1) selected @endif>Đang hoạt
                                                                            động</option>
                                                                        <option value="0" @if ($manga->verified == 0) selected @endif>Ngừng
                                                                            hoạt động</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="thumbnail">
                                                                    <div class="thumb">
                                                                        <a href="{{ asset('/storage/images/mangas/' . $manga->image) }}" data-lightbox="1" data-title="My caption 1">
                                                                            <img src="{{ asset('/storage/images/mangas/' . $manga->image) }}" alt="" class="img-fluid img-thumbnail">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="file" class="form-control" name="image" placeholder="hình ảnh mới">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                ...
                                                <div class="tab-pane" id="messages7" role="tabpanel">
                                                    <div class="md-float-material card-block">
                                                        @foreach ($manga->mangaCategories as $mangamanga)
