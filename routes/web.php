...
use App\Http\Controllers\Manager\MangaController;
use app\Http\Helpers\UploadImage;
use App\Http\Controllers\Manager\CategoryController;
use App\Http\Controllers\Manager\ChapterController;
use App\Http\Controllers\Manager\DetailController;
...
Route::prefix('manager')->as('manager.')->namespace('Manager')->group(function (){
    Route::get('/', function() {
        return view('admin.pages.dashboard.index');
    })->name('index');
